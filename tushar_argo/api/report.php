...
$user_id = $_SESSION['userdata']['id']; // Get logged-in user ID
...
$sql = "SELECT * FROM orders ORDER BY order_date DESC LIMIT $start, $limit";
...
<div class="container ">
    <div class="card shadow-lg">
        <div class="card-header bg-success text-white text-center">
            <h4>📊 Order Reports (<?php echo $totalRecords; ?>)</h4>
        </div>
        <div class="card-body">
